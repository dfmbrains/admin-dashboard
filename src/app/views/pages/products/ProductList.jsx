...
import { H5, Small, Span } from "app/components/Typography";
    ...
    },
    {
      ...
      options: {
        ...
        customBodyRenderLite: dataIndex => {
          ...
          if (quantity === 0)
            return <StyledSpan bgColor={bgError}>Out of Stock</StyledSpan>;
          else if (quantity >= 30)
            return <StyledSpan bgColor={bgGreen}>Available</StyledSpan>;
          else if (quantity < 30)
